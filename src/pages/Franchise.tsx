...
const Franchise: React.FC = () => {
  ...
  const franchiseBenefits = [
    {
      ...
      description:
        "Full training on operations, customer service, and product preparation.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "24/7 operational support and regular business consultations.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Reliable access to quality ingredients through our established supply network.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Complete branding kit, marketing materials, and digital presence support.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Detailed SOPs, quality standards, and operational best practices.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Join a growing family of franchise partners sharing experiences and growth.",
    },
  ];
  ...
  const franchiseModels = [
    ...
    },
    {
      ...
      investment: "₹X - ₹X Lakhs",
      area: "300-500 sq. ft.",
      features: ["Full menu offering", "Dine-in seating", "Premium locations"],
    ...
    },
    {
      ...
      investment: "₹X - ₹X Lakhs",
      area: "800+ sq. ft.",
      features: ["Complete experience", "Events space", "Premium branding"],
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center mt-10 text-gray-500 text-sm">
            * Investment details are placeholders. Contact us for actual figures
